...
;;;;
;;;;    based on llrbtree.lisp by Pascal J. Bourguignon <pjb@informatimago.com>
;;;;

(defpackage :x
  (:use :cl)
  (:export make-tree tree-p tree-empty-p tree-count tree-lessp tree-get
           tree-delete tree-delete-min tree-delete-max map-tree
           with-tree-iterator tree-clear tree-diagram dump))
...
(defstruct (tree (:predicate tree-p)
...
(defun tree-empty-p (tree)
  ...
  (and (tree-p tree) (null (tree-root tree))))
...
(defmethod tree-diagram ((self tree))
